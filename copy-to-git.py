...
source = 'C:/Users/むずでょ/source/repos/kifu-for-js'
destination = 'C:/Users/むずでょ/Documents/GitHub/kifu-for-js'


def go():
    print('Trace   | Remove.')
    remove_destination_dir('/legacy')
    remove_destination_dir('/myfirstreact')
    remove_destination_file('/copy-to-git.py')
    remove_destination_file('/README.md')

    print('Trace   | Copy.')
    copy_dir('/legacy', ignore=shutil.ignore_patterns('node_modules'))
    copy_dir('/myfirstreact', ignore=shutil.ignore_patterns('node_modules'))
